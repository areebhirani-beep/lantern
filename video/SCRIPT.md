...
**[0:30, what it does, say this clearly]**
...
- **Demo footage:** I script the browser, so it is easy to redo (slower, different order, a feature held longer, a different language). The raw 2K clip lives at `lantern-recordings/out/lantern-demo.webm`, the 60fps version at `lantern-recordings/out/demo-60.mp4`.
- **Clip lengths:** if your read runs longer or shorter than a scene, tell me which beat and I will retime it.
