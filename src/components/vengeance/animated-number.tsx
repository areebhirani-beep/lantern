...
function RenderStrip({ eleHeight, value }: { eleHeight: string | null, value: string }) {
    ...
    // The odometer intentionally compares against the previous value during render
    // to pick the roll direction; this ref read is by design.
...
function AnimatedScore({ value, duration = 0.2, className }: { value: number, duration?: number, className?: string }) {
    ...
    // Direction is derived from the previous value during render, by design.
    // eslint-disable-next-line react-hooks/refs
