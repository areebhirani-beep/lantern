...
// @ts-expect-error "react-icons" is not installed in this environment; this component is not wired into the page.
import { FaGithub, FaTwitter, FaFacebook, FaInstagram, FaLinkedin, FaEnvelope, FaDiscord } from "react-icons/fa";
