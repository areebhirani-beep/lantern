...
const AnimatedButton: React.FC<AnimatedButtonProps> = ({
  ...
  const Component =
    (motion as unknown as Record<string, React.ElementType>)[as] || motion.button;
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        initial={{ "--mask-x": "100%" } as unknown as TargetAndTransition}
        animate={{ "--mask-x": "-100%" } as unknown as TargetAndTransition}
        transition={{
          repeat: Infinity,
          duration: 1,
          ease: "linear",
