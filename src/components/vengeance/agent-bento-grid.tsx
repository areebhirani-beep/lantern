...
// @ts-expect-error @phosphor-icons/react is not installed in this environment; this demo component is not wired into the page.
import { ChatCircle, Brain, Database, TerminalWindow, Code, FileText, SlackLogo, NotionLogo, Check, CircleNotch, Clock, Minus, Globe } from "@phosphor-icons/react";
