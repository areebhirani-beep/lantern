  ...
  return (
    ...
    >
      ...
      {isHovered && (
        <>
          <motion.span
            className="absolute top-0 left-[-2px] z-0 text-ember opacity-70 mix-blend-screen"
          ...
          <motion.span
            className="absolute top-0 left-[2px] z-0 text-pounamu opacity-70 mix-blend-screen"
            initial={{ x: 0, opacity: 0 }}
            animate={{ x: [2, -2, 1, -3, 0], opacity: [0, 0.8, 0.4, 0.9, 0] }}
